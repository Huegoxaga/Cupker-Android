...
public final class User implements Model {
  ...
  public static final QueryField LAST_NAME = field("User", "last_name");
  ...
  private User(String id, String username, String email, String first_name, String last_name) {
    this.id = id;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String username, String email, String firstName, String lastName) {
      super.id(id);
